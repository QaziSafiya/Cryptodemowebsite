...
const Navbar = () => {
  ...
  return (
    ...
    <div className='text-white text-2xl font-bold first-letter:text-4xl'>BRAND.</div>
     ...
     <ul className='hidden md:flex'>
         ...
         <li className=' text-xl px-3 mx-3'><Link  to="support"  smooth={true}  duration={500} >
        Support
         </Link></li>
 
         <li className=' text-xl px-3 mx-3'><Link  to="notifications"  smooth={true}  duration={500} >
        Notifications
         </Link></li>
  ...
  {/*Mobile menue*/}
   ...
   <ul className={!state ? 'hidden' :'absolute top-0 left-0 w-full h-screen flex flex-col bg-blue-950 justify-center items-center '}>
